...
\begin{minipage}[t]{0.585\textwidth}
    \begin{customcenter}[5pt]
        ...
        \begin{tikzpicture}[background rectangle/.style={fill=blue!10}, show background rectangle]
            ...
            \draw[decorate,decoration={brace,amplitude=8pt},thick] (5.20,-3.75) -- (8.30,-3.75);
    ...
    \begin{customcenter}[5pt]
        ...
        \begin{tikzpicture}        
            \begin{scope}[xshift=0.75cm]
                ...
                \node[rectangle,fill=yellow!30,minimum width=7.7cm,minimum height=3.9cm] at (3.65,-1.5){};
                \node[rowcodeshader] at (4,+0.0) {\texttt{\#version 330}};
                \node[rowcodeshader] at (4,-0.5) {\texttt{layout (location = 0) in vec4 aPosition;}};
                \node[rowcodeshader] at (4,-1.0) {\texttt{void main()\{gl\_Position = aPosition;\}}};
                \node[rowcodeshader] at (4,-2.0) {\texttt{\#version 330}};
                \node[rowcodeshader] at (4,-2.5) {\texttt{out vec4 fColor;}};
                \node[rowcodeshader] at (4,-3.0) {\texttt{void main()\{fColor = vec4(1,0,0,1);\}}};
            \end{scope}
